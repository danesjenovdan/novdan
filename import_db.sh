...
DATABASE_NAME="novdanapi"
K8S_NAMESPACE="novdan"
SECRETS_NAME="novdan-secrets"
...
# docker container exec -i $(docker compose ps -q db) psql -U novdanapi novdanapi < db.dump
